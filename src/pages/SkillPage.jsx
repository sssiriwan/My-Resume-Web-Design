    ...
    <div id="app-wrapper-skill" className=" w-full">
      ...
      <div id="skill-list" className=" w-full grid gap-x-8 gap-y-14 grid-cols-3 place-items-center text-left ">
        ...
        <div id="skill" className=" relative w-[350px] h-[200px]  border-solid border-2 border-[#6D6D6D] rounded-tr-[50px] ">
          <img id="skill-image" className=" absolute left-6 -top-10 w-[100px] " src="..\src\image\Frame 1.png" />
        ...
        <div id="skill" className=" relative w-[350px] h-[200px]  border-solid border-2 border-[#6D6D6D] rounded-tr-[50px] ">
          <img id="skill-image" className=" absolute left-6 -top-10 w-[100px] " src="src/image/Frame 2.png" />
        ...
        <div id="skill" className=" relative w-[350px] h-[200px]  border-solid border-2 border-[#6D6D6D] rounded-tr-[50px] ">
          <img id="skill-image" className=" absolute left-6 -top-10 w-[100px] " src="src/image/Frame 3.png" />
        ...
        <div id="skill" className=" relative w-[350px] h-[200px]  border-solid border-2 border-[#6D6D6D] rounded-tr-[50px] ">
          <img id="skill-image" className=" absolute left-6 -top-10 w-[100px] " src="src/image/Frame 4.png" />
        ...
        <div id="skill" className=" relative w-[350px] h-[200px]  border-solid border-2 border-[#6D6D6D] rounded-tr-[50px] ">
          <img id="skill-image" className=" absolute left-6 -top-10 w-[100px] " src="src/image/Frame 5.png" />
        ...
        <div id="skill" className=" relative w-[350px] h-[200px]  border-solid border-2 border-[#6D6D6D] rounded-tr-[50px] ">
          <img id="skill-image" className=" absolute left-6 -top-10 w-[100px] " src="src/image/Frame 6.png" />
